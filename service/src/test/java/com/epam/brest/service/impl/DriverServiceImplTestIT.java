...
class DriverServiceImplTestIT {
    ...
    @Test
    void tryToCreateEqualsDriver() {
        LOG.info("Method started: tryToCreateEqualsDriver() of {}", getClass().getName());
        assertNotNull(driverService);
        Driver driver = new Driver("VERANICA", Instant.parse("2002-09-15T08:09:12.4342Z"), new BigDecimal(720));
    ...
    void checkDeleteDriverById() {
        ...
        assertNotNull(driverService);
        driverService.saveDriver(new Driver("SERGEY", Instant.parse("2002-09-15T08:09:12.4342Z"), new BigDecimal(720)));
        List<Driver> drivers = driverService.findAllDrivers();
