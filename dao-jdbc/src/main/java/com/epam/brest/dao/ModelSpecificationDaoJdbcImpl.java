...
@Repository
public class ModelSpecificationDaoJdbcImpl implements ModelSpecificationDao {

    public static final Logger LOG = LogManager.getLogger(ModelSpecificationDaoJdbcImpl.class);
    ...
    public ModelSpecificationDaoJdbcImpl(NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
