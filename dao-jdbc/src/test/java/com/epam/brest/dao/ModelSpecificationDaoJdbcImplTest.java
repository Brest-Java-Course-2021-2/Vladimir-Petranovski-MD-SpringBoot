...
class ModelSpecificationDaoJdbcImplTest {

    public static final Logger LOG = LogManager.getLogger(ModelSpecificationDaoJdbcImplTest.class);

    @InjectMocks
    private ModelSpecificationDaoJdbcImpl modelSpecificationDao;
